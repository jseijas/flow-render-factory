 ...
 */
var FlowRendererText = function (_FlowRenderer) {
  _inherits(FlowRendererText, _FlowRenderer);

  function FlowRendererText(settings) {
    _classCallCheck(this, FlowRendererText);

    var _this = _possibleConstructorReturn(this, (FlowRendererText.__proto__ || Object.getPrototypeOf(FlowRendererText)).call(this, settings));
  ...
  return FlowRendererText;
}(_flowRenderer2.default);

exports.default = FlowRendererText;